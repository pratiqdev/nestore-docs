...
See **[the examples](/examples)** for a better 
look at setting up your store in different environments or continue to **[The Store](/docs/category/the-store)** have a closer look.