...
The original `nestore` package has been removed from npm and will be replaced with `@pratiq/nestore`
and will follow standard semantic-versioning practices starting with version `0.0.44`
:::